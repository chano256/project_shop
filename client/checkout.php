...
<head>
    ...
    <title>Checkout | Happy Shop</title>
    <link href="src/css/bootstrap.min.css" rel="stylesheet">
    <link href="src/css/font-awesome.min.css" rel="stylesheet">
    <link href="src/css/prettyPhoto.css" rel="stylesheet">
    <link href="src/css/price-range.css" rel="stylesheet">
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="src/images/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="src/images/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="src/images/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="src/images/ico/apple-touch-icon-57-precomposed.png">
</head><!--/head-->
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href=""><i class="fa fa-phone"></i> +8613018900125</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> allanochan@yahoo.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
	...
	<section id="cart_items">
		<div class="container">
			...
			{
				mysqli_query($db,"INSERT INTO checkout_address (id, fname, lname, email, address, city, pincode, contactno) 
values('{}','{$_POST["firstname"]}','{$_POST["lastname"]}','{$_POST["email"]}','{$_POST["resi"]}','{$_POST["city"]}','{$_POST["pincode"]}','{$_POST["cno"]}')");
					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img src="src/images/cart/one.png" alt=""></a>
							</td>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="src/images/cart/two.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="src/images/cart/three.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
	...
	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							...
							<p>Lorem ipsum dolor sit amet, you will love this car</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2018 Ex-Cart Inc. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Ochan Inc</a></span></p>
				</div>
			</div>
		</div>
