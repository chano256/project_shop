...
<form action="<?php echo $paypal_url;?>/cgi-bin/webscr" method="post" name="buyCredits" id="buyCredits">
    ...
    <input type="hidden" name="business" value="allanochan@yahoo.com">
    ...
    <input type="hidden" name="return" value="http://localhost:8505/project_shop/client/payment_success.php?id=<?php echo $order_id; ?>">
</form>
<script type="text/javascript">
