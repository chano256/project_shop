...
?>
  ...
  <form class="login-container" name="form1" action="" method="post">
    ...
    <p><input type="submit" name="submit1" value="Register"></p>
  </form>
</div>
	...
	{	    
	    $query  = "INSERT INTO users (username, email, password) VALUES ('{$_POST["username"]}', '{$_POST["email"]}', '{$_POST["pwd"]}')";
    ...
    <footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2019 Shop Mart Inc. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="#">Me</a></span></p>
				</div>
			</div>
		</div>
